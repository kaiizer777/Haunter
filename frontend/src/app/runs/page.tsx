          ...
          <div className="flex flex-wrap items-center gap-3.5 flex-1 min-w-[300px]">
            ...
            <div className="relative w-64">
              ...
              <Input
                ...
                className="h-9 pl-9 pr-8 text-xs font-mono rounded-[6px] bg-zinc-900/50 border-zinc-800/80 focus:border-zinc-700 placeholder:text-zinc-500 placeholder:font-sans"
              />
              {!searchQuery ? (
